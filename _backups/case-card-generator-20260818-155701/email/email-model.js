...
export const EMAIL_TOKENS = Object.freeze({
  colors: Object.freeze({ navy: "#084E7D", deepNavy: "#20293D", cyan: "#00B6E4", lightCyan: "#C1ECFB", pale: "#E1F5FB", white: "#FFFFFF", ink: "#1F282C", muted: "#68757B", purple: "#9C2EDD", purpleText: "#BA6DE7", magenta: "#D958E5" }),
...
export function createBlock(type, overrides = {}) {
  ...
  const presets = {
    ...
    text: { content: { plate: "", listStyle: "bullet", align: "left", body: "Добавьте основной текст. Разделяйте абзацы пустой строкой, а пункты списка начинайте с дефиса." } },
    ...
    iconGrid: { variant: "light", content: { heading: "", columns: "2", iconPosition: "top", items: [
